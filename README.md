...
- **Similar to UMLGraph for Java 8**: While UMLGraph served Java-8 automating class-diagram generation well,  UMLGenerator is an alternative for the same purpose for recent Java versions, contributing to automate Project documentation so it can be always up-to-date. Class-diagrams of this project's Javadocs were generated by using this implementation.
