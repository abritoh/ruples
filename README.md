...
### UMLGenerator
- **Automates PlantUML Class Diagram Generation**: UMLGenerator takes your Java classes and automatically generates PlantUML class diagrams.
- **Similar to UMLGraph for Java 8**: While UMLGraph served Java-8 automating class-diagram generation well,  UMLGenerator is an alternative for the same purpose for recent Java versions, contributing to automate Project documentation so it can be always up-to-date.
...
This project combines the power of Java's latest features with practical tools that help during development making the process more efficient. Dive in and see how Ruples can enhance your coding experience!
