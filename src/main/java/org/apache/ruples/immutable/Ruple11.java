...
import org.apache.ruples.mutable.*;
 ...
 * <div style="text-align:center;"><img src="{@docRoot}/generated-resources/plantuml/images/Ruple11.png" alt="UML Diagram"></div>
 * 
 * @since 2024-1118
 * @author ClusterBR
 */
public record Ruple11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
    ...
    public <T12> 
        ...
        createNext(T12 twelfth) {
        return new Ruple12<>(this.first, this.second, this.third, this.fourth, this.fifth, this.sixth, this.seventh, this.eighth, this.ninth, this.tenth, this.eleventh, twelfth);
    }               
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> 
        ...
        of(T1 first, T2 second, T3 third, T4 fourth, T5 fifth, T6 sixth, T7 seventh, T8 eighth, T9 ninth, T10 tenth, T11 eleventh) {
        return new Ruple11<>(first, second, third, fourth, fifth, sixth, seventh, eighth, ninth, tenth, eleventh);
    }     
     ...
     * 
     * @param record
     * @return a mutable Tuple with 11-values
     */
    public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> 
