 ...
 * <div style="text-align:center;"><img src="{@docRoot}/generated-resources/plantuml/images/Ruple4.png" alt="UML Diagram"></div>
 * 
 * @since 2024-1118
 * @author ClusterBR
 */
public record Ruple4<T1, T2, T3, T4> (
    T1 first, 
    T2 second, 
    T3 third, 
    T4 fourth
    ...
    public <T5> 
        ...
        createNext(T5 fifth) {
        return new Ruple5<>(this.first, this.second, this.third, this.fourth, fifth);
    }   
    ...
    public static <T1, T2, T3, T4> 
        ...
        return new Ruple4<>(first, second, third, fourth);
    }     
     ...
     * 
     * @param record
     * @return a mutable Tuple with 4-values
     */
    public static <T1, T2, T3, T4> 
        Tuple4<T1, T2, T3, T4> 
