 ...
 * <div style="text-align:center;"><img src="{@docRoot}/generated-resources/plantuml/images/Ruple6.png" alt="UML Diagram"></div>
 * 
 * @since 2024-1118
 * @author ClusterBR
 */
public record Ruple6<T1, T2, T3, T4, T5, T6>
    ...
    public <T7> 
        ...
        createNext(T7 seventh) {
        return new Ruple7<>(this.first, this.second, this.third, this.fourth, this.fifth, this.sixth, seventh);
    }              
    ...
    public static <T1, T2, T3, T4, T5, T6> 
        ...
        return new Ruple6<>(first, second, third, fourth, fifth, sixth);
    }     
     ...
     * 
     * @param record
     * @return a mutable Tuple with 6-values
     */
    public static <T1, T2, T3, T4, T5, T6> 
