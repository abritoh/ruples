 ...
 * <div style="text-align:center;"><img src="{@docRoot}/generated-resources/plantuml/images/Ruple9.png" alt="UML Diagram"></div>
 * 
 * 
 * @since 2024-1118
 * @author ClusterBR
 */
public record Ruple9<T1, T2, T3, T4, T5, T6, T7, T8, T9>
    ...
    public <T10> 
        ...
        createNext(T10 tenth) {
        return new Ruple10<>(this.first, this.second, this.third, this.fourth, this.fifth, this.sixth, this.seventh, this.eighth, this.ninth, tenth);
    }              
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, T9> 
        ...
        return new Ruple9<>(first, second, third, fourth, fifth, sixth, seventh, eighth, ninth);
    }     
     ...
     * 
     * @param record
     * @return a mutable Tuple with 9-values
     */
    public static <T1, T2, T3, T4, T5, T6, T7, T8, T9> 
