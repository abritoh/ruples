 ...
 * <div style="text-align:center;"><img src="{@docRoot}/generated-resources/plantuml/images/Tuple11.png" alt="UML Diagram"></div>
 * 
 * @since 2024-1118
 * @author ClusterBR
 */
@XmlRootElement(name = "Tuple11")
public class Tuple11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> implements Serializable {
    private T1 v1;
    private T2 v2;
    private T3 v3;
    private T4 v4;
    ...
    public String toString() {
        return String.format("Tuple11(v1=%s, v2=%s, v3=%s, v4=%s, v5=%s, v6=%s, v7=%s, v8=%s, v9=%s, v10=%s, v11=%s)", v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11);
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(v1, tuple11.v1) && Objects.equals(v2, tuple11.v2) && 
               Objects.equals(v3, tuple11.v3) && Objects.equals(v4, tuple11.v4) && 
               Objects.equals(v5, tuple11.v5) && Objects.equals(v6, tuple11.v6) && 
               Objects.equals(v7, tuple11.v7) && Objects.equals(v8, tuple11.v8) && 
               Objects.equals(v9, tuple11.v9) && Objects.equals(v10, tuple11.v10) && 
    ...
    public <T12> 
        ...
        createNext(T12 v12) {
        return new Tuple12<>(this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, this.v7, this.v8, this.v9, this.v10, this.v11, v12);
    }
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> 
        Tuple11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> 
        fromRecord(Ruple11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> record) {
        return new Tuple11<>(record.first(), record.second(), record.third(), record.fourth(), record.fifth(), record.sixth(), record.seventh(), record.eighth(), record.ninth(), record.tenth(), record.eleventh());
    }
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> 
        ...
        toRecord(Tuple11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> tuple) {
        return new Ruple11<>(tuple.getV1(), tuple.getV2(), tuple.getV3(), tuple.getV4(), tuple.getV5(), tuple.getV6(), tuple.getV7(), tuple.getV8(), tuple.getV9(), tuple.getV10(), tuple.getV11());
    }
