 ...
 * <div style="text-align:center;"><img src="{@docRoot}/generated-resources/plantuml/images/Tuple7.png" alt="UML Diagram"></div>
 * 
 * @since 2024-1118
 * @author ClusterBR
 */
@XmlRootElement(name = "Tuple7")
public class Tuple7<T1, T2, T3, T4, T5, T6, T7> implements Serializable {
    ...
    public String toString() {
        return String.format("Tuple7(v1=%s, v2=%s, v3=%s, v4=%s, v5=%s, v6=%s, v7=%s)", v1, v2, v3, v4, v5, v6, v7);
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(v1, tuple7.v1) && Objects.equals(v2, tuple7.v2) && 
               Objects.equals(v3, tuple7.v3) && Objects.equals(v4, tuple7.v4) && 
               Objects.equals(v5, tuple7.v5) && Objects.equals(v6, tuple7.v6) && 
     ...
     */
    public <T8> Tuple8<T1, T2, T3, T4, T5, T6, T7, T8> 
        createNext(T8 v8) {
        return new Tuple8<>(this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, this.v7, v8);
    }
