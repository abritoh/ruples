 ...
 * <div style="text-align:center;"><img src="{@docRoot}/generated-resources/plantuml/images/Tuple8.png" alt="UML Diagram"></div>
 * 
 * @since 2024-1118
 * @author ClusterBR
 */
@XmlRootElement(name = "Tuple8")
public class Tuple8<T1, T2, T3, T4, T5, T6, T7, T8> implements Serializable {
    ...
    public String toString() {
        return String.format("Tuple8(v1=%s, v2=%s, v3=%s, v4=%s, v5=%s, v6=%s, v7=%s, v8=%s)", v1, v2, v3, v4, v5, v6, v7, v8);
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(v1, tuple8.v1) && Objects.equals(v2, tuple8.v2) && 
               Objects.equals(v3, tuple8.v3) && Objects.equals(v4, tuple8.v4) && 
               Objects.equals(v5, tuple8.v5) && Objects.equals(v6, tuple8.v6) && 
               Objects.equals(v7, tuple8.v7) && Objects.equals(v8, tuple8.v8);
    }
    ...
    public <T9> 
        ...
        createNext(T9 v9) {
            return new Tuple9<>(this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, this.v7, this.v8, v9);
    }    
